...
public class JobResponse {
    ...
    private Long id;
    private AuthorSummaryResponse postedBy;
    ...
    public AuthorSummaryResponse getPostedBy() { return postedBy; }
    public void setPostedBy(AuthorSummaryResponse postedBy) { this.postedBy = postedBy; }
